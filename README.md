### DISCLAIMER
This repository is a fork from the original Quizzes Tutor project, needed in order to experiment for the course of Software Architectures in IST. Our group's main contribution was the documentation folder containing the documentation of the software's architecture - [Documentation README](documentation/README.md).
