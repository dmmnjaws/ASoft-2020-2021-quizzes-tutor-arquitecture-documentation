...
- **Semantics:** Answer details is roughly speaking, the broad concept (or *generalization*) of "type of answer". The different kinds of answer details (it's inheritances) are the concrete (or *specialized*) types of answers. For instance, different types of questions may require different kinds of answers, which should be treated differently: A multiple choice question requires a multiple choice answer; an open question requires a written answer.

- **Origin:** This entity results from the **answer** module.

*Refer to the **Rationale's section DD1.** below for reasoning on possible considerations/solutions in the optics of Domain Driven Design.*
...
- **Semantics:** An assessment is a group of questions polled from a conjunction of topics (Refer to **TopicConjunction** to understand how an assessment is mapped to a conjunction of topics). An assessment exists exclusively in the context of a course's execution, since even though the questions remain the same across multiple executions of the course, the assessments should be created according to annual/semiannual necessities.

- **Origin:** This entity results from the **question** module.
...
- **Origin:** This entity results from the **auth** module.

This entity has an associated vulnerability. Refer to the [Aspects View](module_view_aspects.md) for a detailed explanation.
...
- **Origin:** This entity results from the **course** module.
...
- **Semantic:** A course execution corresponds to an annual/semiannual execution of a course. For example, the course of *Software Arquitectures* had multiple executions including 2017/2018, 2018/2019 and 2019/2020.
...
- **Origin:** This entity results from the **discussion** module.
...
- **Origin:** This entity results from the **statement** module.
...
This entity corresponds to a question's data and it's identified by a unique Integer id. It's a weak entity depending on one and only one **Course**.
...
- **Origin:** This entity results from the **questionsubmission** module.
...
- **Origin:** This entity results from the **quiz** module.
...
- **Semantics:** A quiz answer corresponds to the grouping of the user's answers to all questions in a quiz, from the moment a question appears on the screen, to the moment he/she "ends" the quiz.
...
- **Origin:** This entity results from the **tournament** module.
